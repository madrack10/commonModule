...
import { PupupFormComponent } from './app/pupup-form/pupup-form.component'
...
@NgModule({
  ...
  entryComponents: [DialogOverviewExample, PupupFormComponent],
  declarations: [DialogOverviewExample, PupupFormComponent],
